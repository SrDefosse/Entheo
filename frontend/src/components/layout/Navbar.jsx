...
const CTAs = () => {
  return (
    <div className="flex items-center gap-3">
      <button className="rounded-lg border-2 border-neutral-800 bg-neutral-800 px-4 py-2 font-semibold text-white transition-colors hover:border-neutral-600 hover:bg-neutral-600">
        Shop Now
      </button>
    </div>
  );
...
const AboutUsContent = () => {
  return (
    <div className="grid h-fit w-full grid-cols-12 shadow-xl lg:h-72 lg:w-[600px] lg:shadow-none xl:w-[750px] rounded-lg overflow-hidden">
      <div className="col-span-12 flex flex-col justify-between bg-neutral-800 p-6 lg:col-span-4">
        <div>
...
const CareersContent = () => {
  return (
    <div className="grid w-full grid-cols-12 shadow-xl lg:w-[750px] rounded-lg overflow-hidden">
      <div className="col-span-12 flex flex-col justify-between bg-neutral-800 p-6 lg:col-span-4">
        <div className="mb-6">
